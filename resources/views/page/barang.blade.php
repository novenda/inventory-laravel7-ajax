...
<div class="page-wrapper">
	<div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        	<div class="breadcrumb-title pe-3">Data Master Barang</div>
        	<div class="ms-auto">
                <div class="ps-3">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
        		<div class="modal-content">
        			<div class="modal-header">
        				<h5 class="modal-title" id="ModalLabel">Input Master Barang</h5>
                    ...
                    <input type="hidden" name="id" id="id">
                        <div class="row mb-3">
                            <label for="input-data" class="col-sm-3 col-form-label">Kode Barang</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="kode_barang" placeholder="Kode Barang">
                        </div>
						</div>
                        <div class="row mb-3">
                            <label for="input-data" class="col-sm-3 col-form-label">Nama Barang</label>
                            <div class="col-sm-9">
...
@push('scripts')
<script src="assets/script/barang.js"></script>
@endpush